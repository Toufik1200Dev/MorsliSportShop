...
export interface ApiOrderSubmissionOrderSubmission
  extends Struct.SingleTypeSchema {
  collectionName: 'order_submissions';
  info: {
    displayName: 'Order Submission';
    pluralName: 'order-submissions';
    singularName: 'order-submission';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-submission.order-submission'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Product_category: Schema.Attribute.Enumeration<
      ['all', 'Football', 'Sport de Combat', 'Gym']
    > &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-submission.order-submission': ApiOrderSubmissionOrderSubmission;
